package com.project.aquaodyssey_backend.swagger;
...
public class OpenApiConfig {
    ...
    public OpenAPI defineOpenApi() {
        ...
        server.setDescription("Aqua Odyssey");

        Info info = new Info()
                .title("AquaOdyssey Backend API")
                .version("0.1")
                .description("swagger configuration & API testing");
